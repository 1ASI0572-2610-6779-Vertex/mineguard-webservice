...
@Getter public class AnalyticsHistoryRow extends AbstractDomainAggregateRoot<AnalyticsHistoryRow> {
    @Setter private Long id; @Setter private Long driverId; @Setter private Long reportId; @Setter private String date; @Setter private String time; @Setter private String criticality;

...
public final class CompanyPersistenceAssembler {
    ...
    public static Company toDomain(CompanyPersistenceEntity e){ if(e==null)return null; var c=new Company(e.getName(), e.getEdgeApiKey()); c.setId(e.getId()); return c; }
    public static CompanyPersistenceEntity toEntity(Company c){ var e=new CompanyPersistenceEntity(); e.setId(c.getId()); e.setName(c.getName()); e.setEdgeApiKey(c.getEdgeApiKey()); return e; }
}
